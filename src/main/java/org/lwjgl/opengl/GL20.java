...
public class GL20 extends GL15C {
    ...
    public static int glGetShaderi(int shader, int pname) {
        ...
        java.nio.IntBuffer params = java.nio.ByteBuffer.allocateDirect(4).order(java.nio.ByteOrder.nativeOrder()).asIntBuffer();
    ...
    public static void glUniform1fv(int location, FloatBuffer value) { if (Gdx.gl20 != null) { value.rewind(); Gdx.gl20.glUniform1fv(location, value.remaining(), value); } }
    public static void glUniformMatrix4fv(int location, boolean transpose, FloatBuffer value) { if (Gdx.gl20 != null) { value.rewind(); Gdx.gl20.glUniformMatrix4fv(location, 1, transpose, value); } }
    public static void glUniformMatrix4fv(int location, boolean transpose, float[] value) { if (Gdx.gl20 != null) Gdx.gl20.glUniformMatrix4fv(location, 1, transpose, value, 0); }
    public static void glUniformMatrix3fv(int location, boolean transpose, FloatBuffer value) { if (Gdx.gl20 != null) { value.rewind(); Gdx.gl20.glUniformMatrix3fv(location, 1, transpose, value); } }
    ...
    public static void glVertexAttribPointer(int index, int size, int type, boolean normalized, int stride, long pointer) { if (Gdx.gl20 != null) Gdx.gl20.glVertexAttribPointer(index, size, type, normalized, stride, (int) pointer); }
    public static void glVertexAttribPointer(int index, int size, int type, boolean normalized, int stride, ByteBuffer pointer) { if (Gdx.gl20 != null) Gdx.gl20.glVertexAttribPointer(index, size, type, normalized, stride, pointer); }
