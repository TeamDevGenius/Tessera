...
/** Stub for LWJGL GL15. Delegates to LibGDX GL APIs. */
public class GL15 extends GL14C {
    ...
    public static void glBufferData(int target, FloatBuffer data, int usage) {
        if (Gdx.gl20 != null) Gdx.gl20.glBufferData(target, data.remaining() * 4, data, usage);
    }
    ...
    public static void glBufferData(int target, float[] data, int usage) {
        ...
        Gdx.gl20.glBufferData(target, bb.capacity(), bb, usage);
    }
    ...
    public static void glBufferSubData(int target, long offset, FloatBuffer data) {
        ...
        bb.asFloatBuffer().put(data);
        Gdx.gl20.glBufferSubData(target, (int) offset, bb.capacity(), bb);
    }
    ...
    public static void glDeleteBuffers(int buffer) {
        ...
        IntBuffer buf = ByteBuffer.allocateDirect(4).order(ByteOrder.nativeOrder()).asIntBuffer();
        buf.put(0, buffer);
        Gdx.gl20.glDeleteBuffers(1, buf);
    }
